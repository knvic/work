 ...
 */
@Component
public class Modem_cron1 extends EventListener_tv7 {
 ...
 public static AtomicInteger atomicInteger;
   ...
   /*private static int[][] requests = {
    ...
    public static void tv7_cron(CustomerService customerService, LocalDateTime date, Customer cust) throws InterruptedException, TimeoutException, ExecutionException, SerialPortException, IOException {
       ...
       //List<Customer> customerList=customerService.findAllWithDetailTv7_not_block();
        ...
        for (Customer customer:customerList) {
          ...
          //  Thread.sleep(2000);
            ...
            if (listtv7t.size()==0&&listtv7.size()!=0) {
