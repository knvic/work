...
public class GetListDataImplTest {

    @Test
    public void getTv7TList() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
...
/// конец Подготовка объекта OperationTv7T
        ...
        GetListDataImpl getListData=new GetListDataImpl();
        List<DataObjectTv7> objectTv7List =getListData.getTv7TList(operationtv7TList,"TV1");
