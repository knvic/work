...
public class Calculation {
    ...
    public List<Object> archiveXsl(List<Operationtv7> operationtv7List, List<Operationtv7T> operationtv7TList) throws NoSuchFieldException, IllegalAccessException {
    ...
    public void totalXsl(List<Operationtv7> operationtv7List, List<Operationtv7T> operationtv7TList) throws NoSuchFieldException, IllegalAccessException {
