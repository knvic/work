...
*/
       ...
       //// следующий тест
        ...
        String d="01/03/18|72.24 |59.12 |13.12 |362.60|354.13 | 0.00 | 0.00  | 0.00 |354.13 | 4.20 | 2.40 |22.023 |17.348 | 24 | 0  |  |  |  |  |  |  |  |  |  |  |  |  |  |";

        String regularExpression="\\d{2}/\\d{2}/\\d{2}";
        String regularExpression1="\\d{2}/\\d{2}/\\d{2}\\s\\d{2}";
