 ...
 */
@Component
public class Moth_all_Customer_new extends EventListener{
...
for (int countCustomer=0;countCustomer<customerList.size();countCustomer++){
    ...
    Customer customer=customerList.get(countCustomer);
 ...
 */
        ...
        System.out.println( timestamp_daily + " создаем объект operation");
        ...
        operation.setDateServer(Timestamp.valueOf(LocalDateTime.now()));
 ...
 */
          ...
          customer= customerService.findById(id_c);
           Operation operation = new Operation();
                ...
                operation.setTypeOperation("total_current");
...
/*
    ...
    System.out.println("Запись значений итогового архива произведена. Записываем итоговые текущие");
        ...
        operation4.setTypeOperation("total_total");
       /* operation4.setServerVersion(String.valueOf(server_version));
        ...
        //operation.setDateVkt3Ffb();
        operation4.setDateServer(Timestamp.valueOf(LocalDateTime.now()));
