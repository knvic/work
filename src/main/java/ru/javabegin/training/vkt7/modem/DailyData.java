 ...
 */
@Component
public class DailyData extends EventListener{
 ...
 */  ////////////////////////////////////////////////////////////////////////////////
             ...
             * 1 объект
             */
            List<String> command_3FFD = send10Service.s_3FFD(1, 1);
            ...
            //List<String> ff_n=new ArrayList<>();
            System.out.println("\nФормируем 3F FB        4.4 Запрос на запись даты");
            ...
            List<String> command_3FFB = send10Service.s_3FFB(1, date);
            ...
            System.out.println("\n посылаем запрос 3F FB        4.4 Запрос на запись даты.");
            Thread.sleep(5000);
            serialPort.writeIntArray(request);
            ...
            while(step==20){
                if (data2.contains("3F FB ")){
                    t=1;
                    //System.out.println("После запроса 3F FF_n ");
                    System.out.println("Запрс 3F FB; data2 = "+data2);
 ...
 */
            ...
            System.out.println("\n Формируем запрос 3F FE Запрос на чтение данных СУТОЧНЫЕ");
           ff_2=null;
            ...
            //System.out.println("\n request size = "+ request.length);
            Thread.sleep(5000);
            System.out.println("\nЖдем получения всех данных после команды 3F FE (СУТОЧНЫЕ)  ");
            data2="";
            step=21;
            recieve_all_byte=0;
            serialPort.writeIntArray(request);
 ...
 * Ждем начала приема длинных данных.
 */
            System.out.println("\n проверяем работу получения ТЕКУЩИЕ step= "+ step);
            ...
            while (recieve_all_byte==0){
                if (t==2){
                    ...
                    System.out.println("\n Ответ на 3F FE (ТЕКУЩИЕ) не поступил. Ошибка по таймауту. Повторяем запрос");
                    temp = "";
                    z=0;
                    t=0;
                    serialPort.writeIntArray(request);
