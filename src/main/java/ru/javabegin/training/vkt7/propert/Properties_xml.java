...
public class Properties_xml {
    ...
    public static LinkedList<Properts> getProperties() throws JAXBException {
        ...
        list.add(new Properts(0,"t1_1Type", "t1 Тв1",44,57));
        list.add(new Properts(1,"t2_1Type", "t2 Тв1",44,57));
        list.add(new Properts(2,"t3_1Type", "t3 Тв1",44,57));
        list.add(new Properts(3,"V1_1Type", "V1 Тв1",46,59));
        list.add(new Properts(4,"V2_1Type", "V2 Тв1",46,59));
        list.add(new Properts(5,"V3_1Type", "V3 Тв1",46,59));
        list.add(new Properts(6,"M1_1Type", "M1 Тв1",47,60));
        list.add(new Properts(7,"M2_1Type", "M2 Тв1",47,60));
        list.add(new Properts(8,"M3_1Type", "M3 Тв1",47,60));
        list.add(new Properts(9,"P1_1Type", "P1 Тв1",48,61));
        list.add(new Properts(10,"P2_1Type", "P2 Тв1",48,61));
        list.add(new Properts(11,"Mg_1TypeP", "Mг Тв1",52,65));
        list.add(new Properts(12,"Qo_1TypeP", "Qо Тв1",53,66));
        list.add(new Properts(13,"Qg_1TypeP", "Qг Тв1",54,66));
        list.add(new Properts(14,"dt_1TypeP", "dt Тв1",49,62));
        list.add(new Properts(15,"tswTypeP", "tх",50,63));
        list.add(new Properts(16,"taTypeP", "ta",51,64));
        list.add(new Properts(17,"QntType_1HIP", "BНP Тв1",55,0));
        list.add(new Properts(18,"QntType_1P", "BOC Тв1",56,0));
        list.add(new Properts(19,"G1Type", "G1 Тв1",45,0));
        list.add(new Properts(20,"G2Type", "G2 Тв1",45,0));
        list.add(new Properts(21,"G3Type", "G3 Тв1",45,0));
        list.add(new Properts(22,"t1_2Type", "t1 Тв2",44,57));
        list.add(new Properts(23,"t2_2Type", "t2 Тв2",44,57));
        list.add(new Properts(24,"t3_2Type", "t3 Тв2",44,57));
        list.add(new Properts(25,"V1_2Type", "V1 Тв2",46,69));
        list.add(new Properts(26,"V2_2Type", "V2 Тв2",46,69));
        list.add(new Properts(27,"V3_2Type", "V3 Тв2",46,69));
        list.add(new Properts(28,"M1_2Type", "M1 Тв2",47,70));
        list.add(new Properts(29,"M2_2Type", "M2 Тв2",47,70));
        list.add(new Properts(30,"M3_2Type", "M3 Тв2",47,70));
        list.add(new Properts(31,"P1_2Type", "P1 Тв2",48,71));
        list.add(new Properts(32,"P2_2Type", "P2 Тв2",48,71));
        list.add(new Properts(33,"Mg_2TypeP", "Mг Тв2",52,75));
        list.add(new Properts(34,"Qo_2TypeP", "Qо Тв2",53,76));
        list.add(new Properts(35,"Qg_2TypeP", "Qг Тв2",54,76));
        list.add(new Properts(36,"dt_2TypeP", "dt Тв2",49,72));
        list.add(new Properts(37,"tsw_2TypeP", "резерв",50,73));
        list.add(new Properts(38,"ta_2TypeP", "резерв",51,74));
        list.add(new Properts(39,"Qnt_2TypeHIP", "BНP Тв2",55,0));
        list.add(new Properts(40,"Qnt_2TypeP", " BOC Тв2",56,0));
        list.add(new Properts(41,"G1_2Type", "G1 Тв2",45,0));
        list.add(new Properts(42,"G2_2Type", "G2 Тв2",45,0));
        list.add(new Properts(43,"G3_2Type", "G3 Тв2",45,0));
